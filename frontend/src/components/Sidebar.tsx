...
function SidebarContent({
    ...
    return (
        <>
            {/* Brand */}
            <div className="p-6 flex items-center justify-between gap-3 border-b border-slate-800 bg-slate-900">
            ...
            <div className="flex-1 overflow-y-auto py-6 px-3 space-y-8">
                <div className="space-y-1">
                    ...
                    <button className="w-full flex items-center gap-3 px-3 py-2 rounded-xl bg-indigo-600 text-white text-sm font-bold shadow-lg shadow-indigo-600/20 transition-all hover:bg-indigo-500">
                        ...
                        {history.length === 0 ? (
                            ...
                            history.slice(0, 10).map((item, idx) => (
                                <button
                                    ...
                                    className="w-full flex items-center gap-2 px-3 py-2 rounded-lg text-slate-400 hover:text-white hover:bg-slate-800 text-xs text-left group transition-all"
                                >
            ...
            <div className="p-4 mt-auto border-t border-slate-800 bg-slate-900">
                ...
                <button
                    onClick={onSignOut}
                    className="w-full flex items-center justify-center gap-2 px-3 py-2 rounded-xl border border-slate-700 bg-slate-800 hover:bg-red-950/30 hover:text-red-400 hover:border-red-900/50 text-slate-400 text-xs font-semibold transition-all group shadow-sm"
                >
