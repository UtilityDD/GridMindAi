...
def main():
    # Source file path
    md_file = Path(r"D:\Dipankar\MyCodes\AI Projects\indian_standards_markdown\Indian Standard OH Line above 11KV Sec-2.md")
    
    if not md_file.exists():
        logger.error(f"MD file not found at {md_file}")
        return

    # Metadata for IS 5613 (Part 2/Sec 2) : 1985
    entry = {
        "filename": "Indian Standard OH Line above 11KV Sec-2.pdf",
        "ref": "IS-5613-Part-2-Sec-2-1985",
        "date": "20.03.2026",
        "title": "IS 5613 (Part 2/Sec 2) : 1985 - Code of Practice for Design, Installation and Maintenance of Overhead Power Lines, Part 2: Lines Above 11 kV and Up to and Including 220 kV, Section 2: Installation and Maintenance",
        "source_url": "https://github.com/smartlinemanapp/GridMind/blob/main/Indian%20Standard%20OH%20Line%20above%2011KV%20Sec-2.pdf",
        "keywords": "Overhead Power Lines, Transmission Lines, 33kV, 66kV, 110kV, 132kV, 220kV, Installation, Maintenance, Survey, Right-of-Way, Tower Erection, Foundation, Stringing, Earthing, IS 5613, First Revision"
    }
