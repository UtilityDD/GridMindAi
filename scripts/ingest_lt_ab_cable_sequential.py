...
def main():
    # Source file path
    md_file = Path(r"D:\Dipankar\MyCodes\AI Projects\indian_standards_markdown\Indian Standard LT AB Cable.md")
    
    if not md_file.exists():
        logger.error(f"MD file not found at {md_file}")
        return

    # Metadata for IS 14255 (1995)
    entry = {
        "filename": "Indian Standard LT AB Cable.pdf",
        "ref": "IS-14255-1995",
        "date": "20.03.2026",
        "title": "IS 14255 (1995): Aerial Bunched Cables for Working Voltages up to and Including 1100 Volts — Specification",
        "source_url": "https://github.com/smartlinemanapp/GridMind/blob/main/Indian%20Standard%20LT%20AB%20Cable.pdf",
        "keywords": "LT AB Cable, aerial bunched cable, IS 14255, 1100V, ABC system, power distribution, XLPE, PE, insulation, electrical standards"
    }
