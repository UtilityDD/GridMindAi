...
def main():
    # Source file path
    md_file = Path(r"D:\Dipankar\MyCodes\AI Projects\indian_standards_markdown\Indian Standard Testing of Meter.md")
    
    if not md_file.exists():
        logger.error(f"MD file not found at {md_file}")
        return

    # Metadata for IS 15707:2006
    entry = {
        "filename": "Indian Standard Testing of Meter.pdf",
        "ref": "IS-15707-2006",
        "date": "17.03.2026",
        "title": "IS 15707 (2006): Testing, Evaluation, Installation and Maintenance of ac Electricity Meters — Code of Practice",
        "source_url": "https://raw.githubusercontent.com/smartlinemanapp/GridMind/main/Indian%20Standard%20Testing%20of%20Meter.pdf",
        "keywords": "Meter Testing, energy meters, ac electricity meters, IS 15707, installation, maintenance, electrical standards, BIS 2006"
    }
