...
def main():
    # Source file path
    md_file = Path(r"D:\Dipankar\MyCodes\AI Projects\indian_standards_markdown\Indian Standard UG Cable upto 33KV.md")
    
    if not md_file.exists():
        logger.error(f"MD file not found at {md_file}")
        return

    # Metadata for IS 1255-1983
    entry = {
        "filename": "Indian Standard UG Cable upto 33KV.pdf",
        "ref": "IS-1255-1983",
        "date": "17.03.2026",
        "title": "IS 1255 (1983): Code of Practice for Installation and Maintenance of Power Cables Up to and Including 33 kV Rating",
        "source_url": "https://raw.githubusercontent.com/smartlinemanapp/GridMind/main/Indian%20Standard%20UG%20Cable%20upto%2033KV.pdf",
        "keywords": "UG Cable, underground cable, power cables, installation, maintenance, IS 1255, 33kV rating, electrical standards"
    }
