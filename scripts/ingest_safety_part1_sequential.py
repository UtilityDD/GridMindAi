...
def main():
    # Source file path
    md_file = Path(r"D:\Dipankar\MyCodes\AI Projects\indian_standards_markdown\Indian Standard Safety Part 1.md")
    
    if not md_file.exists():
        logger.error(f"MD file not found at {md_file}")
        return

    # Metadata for IS 5216-1-1982
    entry = {
        "filename": "Indian Standard Safety Part 1.pdf",
        "ref": "IS-5216-1-1982",
        "date": "20.03.2026",
        "title": "IS 5216-1 (1982): Recommendations on Safety Procedures and Practices in Electrical Work, Part I: General",
        "source_url": "https://github.com/smartlinemanapp/GridMind/blob/main/Indian%20Standard%20Safety%20Part%201.pdf",
        "keywords": "Safety, Electrical Safety, IS 5216, Safety Practices, Electrical Work, General Safety, Power Systems"
    }
